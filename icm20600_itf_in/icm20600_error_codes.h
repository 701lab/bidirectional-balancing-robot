...
#define ICM20600_WRONG_GYROSCOPE_SCALE_Err              (5 + ICM20600_NAMESPACE_OFFSET)
#define ICM20600_WRONG_ACCELEROMETER_SCALE_Err          (6 + ICM20600_NAMESPACE_OFFSET)
#define ICM20600_WRONG_GYROSCOPE_INDEX_Err              (7 + ICM20600_NAMESPACE_OFFSET)
#define ICM20600_WRONG_ACCELEROMETER_INDEX_Err          (8 + ICM20600_NAMESPACE_OFFSET)
